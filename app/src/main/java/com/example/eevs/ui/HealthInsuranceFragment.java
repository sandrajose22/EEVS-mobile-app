...
import com.example.eevs.databinding.FragmentHealthInsuranceBinding;
...
public class HealthInsuranceFragment extends Fragment {
    ...
    private FragmentHealthInsuranceBinding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding = FragmentHealthInsuranceBinding.inflate(inflater, container, false);
